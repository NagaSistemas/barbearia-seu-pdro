...
export function Gallery() {
  ...
  const galleryImages = ["/image.png", "/image.png", "/image.png", "/image.png", "/image.png", "/image.png"];
  return <section id="gallery" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {galleryImages.map((image, index) => <div key={index} className="overflow-hidden rounded-lg h-64">
