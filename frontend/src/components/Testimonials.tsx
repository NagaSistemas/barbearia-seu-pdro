...
const renderStars = (count: number) => {
  return Array(count).fill(0).map((_, i) => <StarIcon key={i} className="w-4 h-4 fill-barber-red text-barber-red" />);
};
  ...
  return <section id="depoimentos" className="py-16 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => <div key={testimonial.name} className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex text-barber-red mb-3">
